...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        review_str = rev.__str__()
        self.assertIn("[Review] (123456)", review_str)
        self.assertIn("'id': '123456'", review_str)
        self.assertIn("'created_at': " + d_time_repr, review_str)
        self.assertIn("'updated_at': " + d_time_repr, review_str)
...
class TestReview_save(unittest.TestCase):
    ...
    def test_two_saves(self):
        ...
        sleep(0.05)
        rev.save()
        self.assertLess(s_updated_at, rev.updated_at)
