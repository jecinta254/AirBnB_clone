...
class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        base_model.created_at = base_model.updated_at = d_time
        base_model_str = base_model.__str__()
        self.assertIn("[BaseModel] (123456)", base_model_str)
        self.assertIn("'id': '123456'", base_model_str)
        self.assertIn("'created_at': " + d_time_repr, base_model_str)
        self.assertIn("'updated_at': " + d_time_repr, base_model_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        base_model = BaseModel(id="345", created_at=d_time_iso, updated_at=d_time_iso)
        self.assertEqual(base_model.id, "345")
        self.assertEqual(base_model.created_at, d_time)
        self.assertEqual(base_model.updated_at, d_time)
    ...
    def test_instantiation_with_args_and_kwargs(self):
        d_time = datetime.today()
        d_time_iso = d_time.isoformat()
        base_model = BaseModel("12", id="345", created_at=d_time_iso, updated_at=d_time_iso)
        self.assertEqual(base_model.id, "345")
        self.assertEqual(base_model.created_at, d_time)
        self.assertEqual(base_model.updated_at, d_time)
...
class TestBaseModel_save(unittest.TestCase):
    ...
    def test_one_save(self):
        base_model = BaseModel()
        sleep(0.05)
        f_updated_at = base_model.updated_at
        base_model.save()
        self.assertLess(f_updated_at, base_model.updated_at)
    ...
    def test_two_saves(self):
        ...
        f_updated_at = base_model.updated_at
        base_model.save()
        s_updated_at = base_model.updated_at
        self.assertLess(f_updated_at, s_updated_at)
        sleep(0.05)
        base_model.save()
        self.assertLess(s_updated_at, base_model.updated_at)
...
class TestBaseModel_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqual(base_model.to_dict(), t_dict)
